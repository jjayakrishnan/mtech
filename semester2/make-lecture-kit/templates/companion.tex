...
% ---- Callout glyphs ---------------------------------------------------------
% pifont -> crisp ✗ (\ding{55}) and ✓ (\ding{51}); bbding -> pointing hand ☞
% (\Pointinghand) and pencil ✎ (\Pencil). Both ship with every standard TeX
% distribution and need no extra fonts.
\usepackage{pifont}
\usepackage{bbding}
...
\newtcolorbox{intuition}{%
  ...
  title={\raisebox{-0.05ex}{\Pointinghand}\,\ The intuition}}
...
\newtcolorbox{worked}[1]{%
  ...
  title={\raisebox{-0.05ex}{\Pencil}\,\ Worked example: #1}}
