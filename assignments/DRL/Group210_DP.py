...
================================================================================
Group Number  : 210
First Student (alphabetically by first name): AMITH P KASHYAP (2025aa05342)
Last digit of register number: 2  →  Even → 5×5 grid, max battery = 10
Team Members  :
...
ENVIRONMENT CONFIGURATION (derived from register last digit = 2 → 0–4 range)
  Grid size          : 5 × 5
  Rescue targets     : 2
  Charging stations  : 1
  Danger zones       : 3
  Blocked cells      : 2
  Max battery        : 10 (last digit 2 is even)
  Wind probability   : 20% (last digit in 0–4)
  Max steps          : 50
...
TRANSITION DYNAMICS:
  ...
  Wind cell (W) at (2,2): if the drone is ON a wind cell and attempts to move,
    with 20% probability the intended direction is overridden and a uniformly
    random direction (Up/Down/Left/Right) is chosen instead.
...
GRID_ROWS   = 5
GRID_COLS   = 5
MAX_BATTERY = 10          # last digit 2 → even → 10
WIND_PROB   = 0.20        # last digit in 0–4 → 20%
